{
  inputs =
    let
      version = "1.9.1";
system = "x86_64-linux";
devenv_root = "/home/pion/work/dev/meshtastic/meshub";
devenv_dotfile = "/home/pion/work/dev/meshtastic/meshub/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-8e6aae7";
...
hostname = "xixi";
username = "pion";
git_root = "/home/pion/work/dev/meshtastic/meshub";
